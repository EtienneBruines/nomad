...
func (s *StateStore) DeleteJobTxn(index uint64, namespace, jobID string, txn Txn) error {
	...
	netlog.Red("SS.DeleteJob", "jobID", jobID, "namespace", namespace)
...
func (s *StateStore) deleteJobSubmission(job *structs.Job, txn *txn) error {
	...
	netlog.Red("SS.deleteJobSubmission", "namespace", job.Namespace, "name", job.Name, "count", count)
	return err
}
...
func (s *StateStore) jobSubmission(ws memdb.WatchSet, namespace, jobName string, version uint64, txn Txn) (*structs.JobSubmission, error) {
	netlog.Purple("SS.jobSubmission find", "namespace", namespace, "jobName", jobName, "version", version)
	...
	ws.Add(watchCh)
	netlog.Purple("SS.jobSubmission find", "existing", existing)
	if existing != nil {
