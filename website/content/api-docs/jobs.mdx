...
| Method | Path                           | Produces           |
| ------ | ------------------------------ | ------------------ |
|`GET`   | `/v1/job/:job_name/submission` | `application/json` |

### Parameters

- `:job_name` `(string: <required>)` - Specifies the Name of the job (as specified
...
- `JobName`: The name of the job associated with the original job file.
